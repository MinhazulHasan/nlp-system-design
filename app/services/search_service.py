...
async def fetch_pdf_links(company_name: str, num_pages: int = 2) -> List[Tuple[str, str, str, Optional[str]]]:
...
def parse_response(data: List[Dict[str, Any]], company_name: str) -> List[Tuple[str, str, str, Optional[str]]]:
    links = []
    try:
        for item in data:
